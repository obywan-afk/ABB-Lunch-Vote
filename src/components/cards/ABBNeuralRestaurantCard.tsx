    ...
    >
      <div
        className={cn(
          ...
          hasVotedForThis ? 'bg-gradient-to-r from-green-400 to-cyan-400 blur-xl animate-electric-pulse' : 'bg-gradient-to-r from-cyan-500 to-orange-500 blur-xl'
        )}
      />
        ...
        <div className="p-6 relative flex flex-col flex-grow">
          ...
          <div className="mb-4 p-3 bg-slate-950/50 rounded border border-cyan-400/20 flex-grow">
            ...
            {restaurant.parsedMenu ? (
              ...
              <div className="text-cyan-300/60 text-xs font-mono italic">{restaurant.rawMenu}</div>
            ) : (
              <div className="text-orange-500/60 text-sm font-mono">[DATA_UNAVAILABLE]</div>
            )}
          </div>
              ...
              <div className="flex-1">
                {isVotingOpen ? (
                  hasVotedForThis ? (
                    ...
                    >
                      <span className="relative z-10">{userHasVoted ? 'SYSTEM LOCKED' : 'INITIALIZE VOTE'}</span>
                      {!userHasVoted && (
                  ...
                  <div className="text-center py-3 text-orange-500/60 text-sm font-mono">[VOTING_OFFLINE]</div>
                )}
              </div>
            </div>
          </div>
